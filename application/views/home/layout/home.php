          ...
          <div class="col-12 col-lg-4">
            <div class="single-blog-post bg-img mb-80" style="background-image: url(./img/bg-img/8.jpg);">
              ...
              <div class="post-content">
                <span class="post-date"><span><?=$day?></span> <?=$month?>, <?=$year?> - By: <?=$post->admin_nama?></span>
                <a href="<?=base_url('home/blog/').$post->url?>" class="post-title" target="_blank"><?=$post->judul?></a>
                <p><?=word_limiter($post->isi, 30)?></p>
                <a href="<?=base_url('home/blog/').$post->url?>" class="read-more-btn">Read More <i class="arrow_carrot-2right"></i></a>
              </div>
            </div>
          </div>
          <?php
