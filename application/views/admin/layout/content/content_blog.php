...
<div class="content-wrapper">
      ...
      <div class="box-header with-border">
        ...
        <div class="box-body">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form enctype="multipart/form-data" id="submitblog">
              <div class="box-body">
                <div class="form-group">
                  <label for="judul_blog">Judul</label>
                  <input type="text" class="form-control" id="judul_blog" name="judul_blog" placeholder="Nama Layanan" required>
                </div>
                <div class="form-group">
                  <label for="keterangan_blog">Keterangan</label>
                  <textarea class="form-control" id="keterangan_blog" name="keterangan_blog"></textarea>
                </div>
                <div class="form-group">
                  <label for="gambar_blog">Gambar</label>
                  <input type="file" id="gambar_blog" name="gambar_blog" onchange="previewImage();" required>
  ...
  <script type="text/javascript">
    ...
    function show_blog(){
      $.ajax({
        type  : 'ajax',
        url   : "<?php echo base_url('admin/blog_list')?>",
        async : false,
        dataType : 'json',
        success : function(data){
          ...
          for(i=0; i<data.length; i++){
            ...
            '<td> <img src="<?php echo base_url('assets/blog/thumb/')?>'+data[i].gambar+'"></td>'+
    ...
    $('#submitblog').submit(function(e){
      ...
      $.ajax({
       url:"<?php echo site_url('admin/tambah_blog')?>",
       type:"post",
